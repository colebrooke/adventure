...
like it could be used as a weapon in a pinch.',1,3,3,'There is a hammer here.',0,NULL);
INSERT INTO "item" VALUES(2,'diamond','The diamond is the size of a pea and gleams brightly. It has many facets, and looks 
like it would be worth a small fortune.',1,12,12,'You notice a diamond had been dropped here!',0,NULL);
INSERT INTO "item" VALUES(3,'keycard','You look closly at the keycard, it is small and grey. You can just make out the words LOWER CITY.',1,9,9,'A keycard has been discarded here.',0,NULL);
...
is small writing saying B213T.',1,6,6,'A hard drive lies here gathering dust.',0,NULL);
...
though there is still one lone trophy which stands still in the middle of the cabinet.  ',1,1,1,'There is a trophy cabinet here.',1,0);
INSERT INTO "item" VALUES(6,'workbench','There isn''t much remarkable about the workbench.',1,3,3,'A workbench is along one wall.',1,NULL);
INSERT INTO "item" VALUES(7,'laser cutter','The laser cutter looks like it would make a good weapon in the right hands.',1,0,0,'A laser cutter is here.',0,NULL);
...
',1,1,7,'There is a blaster pistol here.',0,NULL);
INSERT INTO "item" VALUES(9,'bed','The bed is plain and unremarkable.  It doesn''t look very comfortable.',1,1,1,'There is a bed in the corner of the room.',1,NULL);
INSERT INTO "item" VALUES(10,'notice board','There is a single notice on the board. 
It says ''Come to the droid shop for the best deals
on R100 droids!''.',1,14,14,'A notice board is attached to one wall.',1,NULL);
INSERT INTO "item" VALUES(11,'rock tower','The rock tower is contructed from large, flat,
square blocks of stone.  It''s quite high and you
can''t reach the top.
There is some writing scrwaled around the base,
which says ''All is red, all is white''.',1,20,20,'A rock tower has been constructed here.',1,NULL);
INSERT INTO "item" VALUES(12,'alien meat','The alien meat is grey and slimy.  The thought of eating it is disgusting to you.',1,0,0,'The is some alien meat.',0,NULL);
INSERT INTO "item" VALUES(13,'alien cookies','The alien cookies are grey and covered in silver insects. You suspect they are probably leathal to humans.',1,0,0,'There are some alien cookies here.',0,NULL);
INSERT INTO "item" VALUES(14,'baked skima','The baked skima looks like a tasty dish. For alien spiders.',1,0,0,'Some baked skima is here.',0,NULL);
INSERT INTO "item" VALUES(15,'gas mask','The gas mask is black in colour, and has attachments for breathing hoses, which are missing.',1,0,0,'You see a gas mask here.',0,NULL);
INSERT INTO "item" VALUES(16,'wen token','The wen token is a small black square, used for unlocking wen devices.',1,0,0,'You see a wen token here.',0,NULL);
INSERT INTO "item" VALUES(17,'rime cutter','The rime cutter is a tiny rusty blade with a jagged edge, used for pealing alien fruit.',1,0,0,'There is a rime cutter here.',0,NULL);
INSERT INTO "item" VALUES(18,'blanket','The blanket is compact and warm.  It should protect it''s user from the harshest cold.',1,0,0,'A blanket has been discarded here.',0,NULL);
INSERT INTO "item" VALUES(19,'vep key','The vep key is a short white object with strange markings on one side.
It could be used to open a weapons locker, or another secure storage.',1,0,0,'A vep key is here.',0,NULL);
...
KELTH.',1,0,0,'A trophy is here',0,NULL);
